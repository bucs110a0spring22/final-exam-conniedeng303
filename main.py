...
def main():
  ...
  print("Troglodytes Troglodytes genus birds are one of the most common birds found in almost every continent. In fact, lets pick a random bird and see if it's near you:")
